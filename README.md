## Sample Network Reference Architecture6
...
## ContosoInc
ContosoInc is a [fictional Microsoft company](https://en.wikipedia.org/wiki/List_of_fictional_Microsoft_companies) which I found to be a very cool name.
